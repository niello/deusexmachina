...
bool CPlatformWin32::RegisterRawInput()
{
	...
	// TODO: can use RIDEV_NOHOTKEYS to disable Windows, Application, Ctrl+Shift+Esc but also PrintScreen, Ctrl+PrintScreen etc.
	// See another way in https://docs.microsoft.com/en-us/windows/desktop/dxtecharts/disabling-shortcut-keys-in-games
