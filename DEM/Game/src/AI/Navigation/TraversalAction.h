...
public:
	...
	virtual bool  GenerateAction(Game::CGameSession& Session, CNavAgentComponent& Agent, Game::HEntity Actor, Game::HEntity Controller, const rtm::vector4f& Pos, CCommandStackComponent& CmdStack, Navigate& NavigateCmd) = 0;
};
