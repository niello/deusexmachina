...
// Destruction of one or another will lead to destruction of the modificator. That's why the
// modificator has to be refcounted. In alive state it has at least 2 references. As soon as refcount
