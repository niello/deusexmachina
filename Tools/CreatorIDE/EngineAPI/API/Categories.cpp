...
API bool Categories_ParseAttrDescs(const char* FileName)
{
...
API int Categories_GetAttrDescCount()
{
	return CIDEApp->AttrDescs->GetCount();
}
//---------------------------------------------------------------------

API const char* Categories_GetAttrDesc(int Idx, char* Cat, char* Desc, char* ResFilter,
