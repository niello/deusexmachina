...
*/
const nLight& nLightNode::RenderLight(nSceneServer* /*sS*/, nRenderContext* /*rC*/, const matrix44& lightTransform)
{
    ...
    if (shd->IsParameterUsed(nShaderState::ModelLightPos))
    {
        ...
        shd->SetVector3(nShaderState::ModelLightPos, Tfm.z_component());
    }
    return this->light;
}
