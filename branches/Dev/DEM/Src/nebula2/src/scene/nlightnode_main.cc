...
bool nLightNode::ApplyLight(nSceneServer*, nRenderContext*, const matrix44& lightTransform, const vector4& shadowLightMask)
{
...
bool nLightNode::RenderLight(nSceneServer*, nRenderContext*, const matrix44& lightTransform)
{
